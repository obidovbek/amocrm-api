...
import { AmocrmOauth2Service } from "./amocrm-oauth2.service";
...
export class AmocrmService implements IAmocrmService{
    ...
    private httpOptions = {
        headers: {
            "Authorization": `Bearer ${this.amocrmOauth2Service.accessToken}`,
            "Content-type": "Application/json"
        }
    }
    constructor(
        @inject(TYPES.ConfigService) private configService:ConfigService,
        @inject(TYPES.AmocrmOauth2Service) private amocrmOauth2Service:AmocrmOauth2Service
    ){
